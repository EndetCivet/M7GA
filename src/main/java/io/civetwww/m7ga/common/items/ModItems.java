...
import io.civetwww.m7ga.common.items.armor.IchorArmorItem;
...
public class ModItems {
    ...
    public static final Supplier<Item> ICHOR_INGOT = ITEMS.register(ICHOR_INGOT_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
    public static final String ICHOR_ROD_ID = "ichor_rod";
    public static final Supplier<Item> ICHOR_ROD = ITEMS.register(ICHOR_ROD_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));
    public static final String ICHOR_CLOTH_ID = "ichor_cloth";
    public static final Supplier<Item> ICHOR_CLOTH = ITEMS.register(ICHOR_CLOTH_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.UNCOMMON)));

    //七彩系列物品
    public static final String RAINBOW_INGOT_ID = "rainbow_ingot";
    public static final Supplier<Item> RAINBOW_INGOT = ITEMS.register(RAINBOW_INGOT_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.RARE)));
    public static final String RAINBOW_CLOTH_ID = "rainbow_cloth";
    public static final Supplier<Item> RAINBOW_CLOTH = ITEMS.register(RAINBOW_CLOTH_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.RARE)));
    //锻造模板、核心
    public static final String ICHOR_CORE_ID = "ichor_core";
    public static final Supplier<Item> ICHOR_CORE = ITEMS.register(ICHOR_CORE_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.EPIC)));
    public static final String RAINBOW_CORE_ID = "rainbow_core";
    public static final Supplier<Item> RAINBOW_CORE = ITEMS.register(RAINBOW_CORE_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.EPIC)));
    public static final String MEGA_TEMPLATE_ID = "mega_template";
    public static final Supplier<Item> MEGA_TEMPLATE = ITEMS.register(MEGA_TEMPLATE_ID,()-> new Item(new Item.Properties().fireResistant().rarity(Rarity.EPIC)));
    ...
    public static final Supplier<ArmorItem> ICHOR_HELMET = ITEMS.register(ICHOR_HELMET_ID, () -> new IchorArmorItem(
            ModArmorMaterials.ICHOR_CLOTH_MATERIAL,
            ArmorItem.Type.HELMET,
            new Item.Properties().fireResistant().rarity(Rarity.EPIC)
    ));
    public static final String ICHOR_CHESTPLATE_ID = "ichor_chestplate";
    public static final Supplier<ArmorItem> ICHOR_CHESTPLATE = ITEMS.register(ICHOR_CHESTPLATE_ID, () -> new IchorArmorItem(
            ModArmorMaterials.ICHOR_CLOTH_MATERIAL,
            ArmorItem.Type.CHESTPLATE,
            new Item.Properties().fireResistant().rarity(Rarity.EPIC)
    ));
    public static final String ICHOR_LEGGINGS_ID = "ichor_leggings";
    public static final Supplier<ArmorItem> ICHOR_LEGGINGS = ITEMS.register(ICHOR_LEGGINGS_ID, () -> new IchorArmorItem(
            ModArmorMaterials.ICHOR_CLOTH_MATERIAL,
            ArmorItem.Type.LEGGINGS,
            new Item.Properties().fireResistant().rarity(Rarity.EPIC)
    ));
    public static final String ICHOR_BOOTS_ID = "ichor_boots";
    public static final Supplier<ArmorItem> ICHOR_BOOTS = ITEMS.register(ICHOR_BOOTS_ID, () -> new IchorArmorItem(
            ModArmorMaterials.ICHOR_CLOTH_MATERIAL,
