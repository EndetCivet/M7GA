...
public class ArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        return LayerDefinition.create(MaidArmorModel.createNormalMesh(), 128, 128);
    }

    public static LayerDefinition createDressLayer() {
        return LayerDefinition.create(MaidArmorModel.createDressMesh(), 128, 128);
    }
}
